...
EOF;
    ...
    function web_code($order, $config_value)
    {
        ...
        $parameter = array(
            ...
            "notify_url"    => SITE_URL.U('publics/Payment/notifyUrl',array('pay_code'=>'alipayApp')) , //服务器异步通知页面路径 //必填，不能修改
            "return_url"    => SITE_URL.U('publics/Payment/returnUrl',array('pay_code'=>'alipayApp')),  //页面跳转同步通知页面路径
