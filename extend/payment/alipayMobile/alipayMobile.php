...
class alipayMobile
{
    ...
    function get_code($order, $config_value)
    {
        ...
        $parameter = array(
            ...
            "notify_url" => _url('publics/payment/notifyUrl', array('pay_code' => 'alipayMobile'), '', true, true), //服务器异步通知页面路径 //必填，不能修改
            "return_url" => _url('publics/payment/returnUrl', array('pay_code' => 'alipayMobile'), true, true),  //页面跳转同步通知页面路径
